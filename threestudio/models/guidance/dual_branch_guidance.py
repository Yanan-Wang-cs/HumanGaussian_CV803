...
class StableDiffusionGuidance(BaseObject):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if true_global_step>=3600:
            ground_truth = Image.open('/home/yanan/cv/second/HumanGaussian/debug/target_decode_9_0.png')
            ...
            pic.save('/home/yanan/cv/second/HumanGaussian/debug/target_origin_'+str(true_global_step)+'_0.jpg')

            generated_img = self.decode_latents(target)
            pic = toPIL(generated_img[0])
            pic.save('/home/yanan/cv/second/HumanGaussian/debug/target_decode_'+str(true_global_step)+'_0.png')
